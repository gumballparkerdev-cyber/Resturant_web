    ...
    <footer className="footer">
      <div className="footer-grid">
        ...
        <div className="footer-brand">
          ...
          <div className="social-links">
            <Link to="https://facebook.com" target="_blank" rel="noreferrer" className="soc-btn" aria-label="Facebook">
              <svg width="14" height="14" viewBox="0 0 24 24" fill="currentColor"><path d="M18 2h-3a5 5 0 0 0-5 5v3H7v4h3v8h4v-8h3l1-4h-4V7a1 1 0 0 1 1-1h3z"/></svg>
            </Link>
            <Link to="https://instagram.com" target="_blank" rel="noreferrer" className="soc-btn" aria-label="Instagram">
            ...
            <Link to="https://twitter.com" target="_blank" rel="noreferrer" className="soc-btn" aria-label="Twitter / X">
              <svg width="14" height="14" viewBox="0 0 24 24" fill="currentColor"><path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z"/></svg>
            </Link>
            <Link to="https://youtube.com" target="_blank" rel="noreferrer" className="soc-btn" aria-label="YouTube">
        ...
        <div className="footer-col">
          <h5>Find Us</h5>
          <ul>
            <li><Link to="https://maps.google.com" target="_blank" rel="noreferrer">14 Via Roma, City Centre</Link></li>
            <li><Link to="tel:+15559876543">+1 (555) 987-6543</Link></li>
            <li><Link to="mailto:hello@bellavista.com">hello@bellavista.com</Link></li>
            <li><Link to="/">Mon – Thu: 8am – 10pm</Link></li>
            <li><Link to="/">Fri – Sun: 8am – 11pm</Link></li>
          </ul>
        </div>
      ...
      <div className="footer-bottom">
        ...
        <div style={{ display: 'flex', gap: '1.5rem', flexWrap: 'wrap' }}>
          <Link to="/" style={{ color: 'rgba(253,246,236,0.22)', fontSize: '0.75rem', textDecoration: 'none' }}>Privacy Policy</Link>
          <Link to="/" style={{ color: 'rgba(253,246,236,0.22)', fontSize: '0.75rem', textDecoration: 'none' }}>Terms of Use</Link>
          <Link to="/" style={{ color: 'rgba(253,246,236,0.22)', fontSize: '0.75rem', textDecoration: 'none' }}>Accessibility</Link>
        </div>
      </div>
    </footer>
  );
